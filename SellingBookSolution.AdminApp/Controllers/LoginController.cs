...
namespace SellingBookSolution.AdminApp.Controllers
{
    public class LoginController : Controller
    {
        ...
        public async Task<IActionResult> Index(LoginRequest request)
        {
            ...
            HttpContext.Session.SetString("DefaultLanguageId", _configuration[SystemConstants.AppSettings.DefaultLanguageId]);
