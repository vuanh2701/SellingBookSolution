...
namespace SellingBookSolution.Application.System.Users
{
    public class UserService : IUserService
    {
        ...
        public UserService(UserManager<AppUser> userManager, SignInManager<AppUser> signInManager, RoleManager<AppRole> roleManager, IConfiguration config) // được lấy từ thư viện của IDentity
        {
